...
def answer(rag_url, key, store, questionnaire, history_table, sub, question,
           at=None, app=False, recommendation=False, timeout=chat.TIMEOUT_SECONDS) -> dict:
    ...
    next-meal recommendation chat. The upstream errors reach the caller as they are — an
