...
// choices sharing a numeric value, to catch id/value mix-ups) plus a drinking question for
// day close. The at_least carbs rule keeps the violation/high-score styling interplay under
// test in the history table.
