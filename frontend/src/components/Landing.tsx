...
export function Landing({ onSignIn }: { onSignIn: () => void }) {
  return (
    <main className="landing">
      <h1>מעקב תזונה</h1>
      <p className="landing-intro">אפליקציית SaaS חינמית — יומן ארוחות יומי שעוזר לשמור על הרגלי אכילה בריאים לאורך זמן:</p>
      <ul className="landing-summary">
        <li>
          רישום ארוחות ביומן מעקב יומי, כולל השלמה של יום אתמול למי שנזכר אחרי חצות
        </li>
        <li>
          ערכי סיכום היום נגזרים מהיומן: ציון פחמימות / קמחים / סוכרים (נמוך = טוב), מספר ארוחות,
          ארוחות עם ירקות וחלון האכילה
        </li>
        <li>
          שאלון סיכום היום אינו יכול להצהיר פחות ממה שנרשם ביומן; יום שתועד במלואו נסגר עם מילוי שתייה בלבד
        </li>
        <li>
          האפליקציה כולל תזכורת כשדיווח של יום חסר, התראה כשכלל תזונתי מופר כמה ימים ברצף, סיכום שבועי וגרף מגמה
