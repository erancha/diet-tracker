  ...
  return (
    <main className="landing">
      ...
      <ul className="landing-summary">
        <li>
          רישום ארוחות תוך כדי היום — דרגת פחמימות, ירקות, פרי ומתוק — כולל השלמה של יום אתמול
          למי שנזכר אחרי חצות
        </li>
        <li>
          ערכי היום נגזרים מהיומן: ציון פחמימות (נמוך = טוב), מספר ארוחות, ארוחות עם ירקות וחלון
          האכילה
        </li>
        <li>
