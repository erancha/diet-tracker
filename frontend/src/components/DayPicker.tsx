...
export function DayPicker({ todayStr, yesterdayStr, value, todaySelectable, dayEndHour, onChange }: Props) {
  return (
    <div className="day-picker">
      <label>
        <input type="radio" name="day" checked={value === "today"} disabled={!todaySelectable}
               title={todaySelectable ? undefined : `שאלון סיכום היום נפתח מ-${dayEndHour}:00`}
