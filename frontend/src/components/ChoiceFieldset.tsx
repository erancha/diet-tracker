...
// are evidence, and the day-end answer can only admit more, never less. The scope prop picks
// which heading qualifier the legend carries (a day's summed answer vs. one meal's grade).
